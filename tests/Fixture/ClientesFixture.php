...
class ClientesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cnpj' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'is_active' => 1,
            'created' => '2018-05-12 19:44:15',
            'created_by' => 1,
            'modified' => '2018-05-12 19:44:15',
            'modified_by' => 1,
            'deleted' => '2018-05-12 19:44:15',
            'deleted_by' => 1
        ],
    ];
}
